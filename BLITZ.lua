--[[
This Script is Decompiled by iksuwu ( 2025/11/25 )いくすわありがとう
 	
 	
___  ___                    _____             _      ______           _   _     _____ _      
|  \/  |                   /  ___|           (_)     | ___ \         | | | |   |  _  | |     
| .  . | ___   ___  _ __   \ `--.  ___  ___   _ ___  | |_/ / __ _  __| | | |   | | | | |     
| |\/| |/ _ \ / _ \| '_ \   `--. \/ _ \/ __| | / __| | ___ \/ _` |/ _` | | |   | | | | |     
| |  | | (_) | (_) | | | | /\__/ /  __/ (__  | \__ \ | |_/ / (_| | (_| | | |___\ \_/ / |____ 
\_|  |_/\___/ \___/|_| |_| \____/ \___|\___| |_|___/ \____/ \__,_|\__,_| \_____/\___/\_____/ 
...
v_u_17_.Changed:Connect(function(p31_)
...
local function v_u_51_(p47_)
	...
	if p47_ then
		...
		local v50_ = (v49_ == "Leader" or (v49_ == "High Rank Admin" or (v49_ == "Low Rank Admin" or v49_ == "Goon"))) and true or v48_
...
function teleportfunc()
	...
	local v91_, v92_ = v_u_7_:FindPartOnRayWithIgnoreList(Ray.new(v89_[v90_].Position, v_u_17_.Character.CamPart.CFrame.lookVector * 5000), {
		v89_
	})
	if v91_ then
...
function CheckNetworkOwnerShipOnPlayer(p114_, p115_)
	-- upvalues: (ref) v_u_17_
	if typeof(p114_) == "Instance" and (p114_:IsA("Player") and p114_.Character) and (p114_.Character:FindFirstChild("Head") and (p114_.Character.Head:FindFirstChild("PartOwner") and p114_.Character.Head.PartOwner.Value == v_u_17_.Name)) then
		return not p115_ and true or p114_.Character.Head.PartOwner
	end
end
function CheckNetworkOwnerShipPermanentOnPlayer(p116_, p117_)
	-- upvalues: (ref) v_u_17_
	if typeof(p116_) == "Instance" and (p116_:IsA("Player") and p116_.Character) and (p116_.Character:FindFirstChild("HumanoidRootPart") and (p116_.Character.HumanoidRootPart:FindFirstChild("FirePlayerPart") and (p116_.Character.HumanoidRootPart.FirePlayerPart:FindFirstChild("PartOwner") and p116_.Character.HumanoidRootPart.FirePlayerPart.PartOwner.Value == v_u_17_.Name))) then
...
function IsPlayerFloating(p123_)
	if typeof(p123_) == "Instance" and (p123_:IsA("Player") and p123_.Character) and (p123_.Character:FindFirstChildOfClass("Humanoid") and p123_.Character:FindFirstChildOfClass("Humanoid").FloorMaterial == Enum.Material.Air) then
		return true
	end
end
	...
	if v_u_17_.Character and v_u_17_.Character:FindFirstChild("HumanoidRootPart") then
		if CheckNetworkOwnerShipOnPart(p_u_126_) then
			...
			if not v129_ then
				...
				p_u_126_.ChildAdded:Connect(function(p130_)
...
function SNOWshipPlayer(p131_, p132_)
	-- upvalues: (ref) v_u_17_, (ref) v_u_24_
	if v_u_17_.Character and (v_u_17_.Character:FindFirstChild("HumanoidRootPart") and (typeof(p131_) == "Instance" and (p131_:IsA("Player") and p131_.Character)) and p131_.Character:FindFirstChild("HumanoidRootPart")) then
...
function SNOWshipPermanentPlayer(p135_, p136_)
	-- upvalues: (ref) v_u_17_, (ref) v_u_24_
	if v_u_17_.Character and (v_u_17_.Character:FindFirstChild("HumanoidRootPart") and (typeof(p135_) == "Instance" and (p135_:IsA("Player") and p135_.Character)) and (p135_.Character:FindFirstChild("HumanoidRootPart") and p135_.Character.HumanoidRootPart:FindFirstChild("FirePlayerPart"))) then
...
function GetPlayerCharacter()
	-- upvalues: (ref) v_u_17_
	if v_u_17_.Character and (v_u_17_.Character:FindFirstChild("HumanoidRootPart") and v_u_17_.Character:FindFirstChildOfClass("Humanoid")) then
...
function autosetownership()
	...
	while true do
		...
		if typeof(v154_.PartAnchored) == "Instance" and (not v153_:GetAttribute("AnchorOwnership") and SNOWshipOnce(v154_.PartAnchored)) then
...
function setanchorObject(p164_)
	...
	if typeof(p164_) == "Instance" and p164_.Parent and (p164_.Parent:IsA("Model") or p164_.Parent:IsA("Folder")) then
		...
		if v166_ or v167_ then
			...
			local v_u_168_ = v_u_165_:FindFirstChild("AnchorPositionBody") or (p164_:FindFirstChild("AnchorPositionBody") or Instance.new("BodyPosition"))
			local v_u_169_ = v_u_165_:FindFirstChild("AnchorGyroBody") or (p164_:FindFirstChild("AnchorGyroBody") or Instance.new("BodyGyro"))
			...
			v171_[1] = v_u_165_.DescendantAdded:Connect(function(p182_)
			...
			v171_[2] = v_u_165_.DescendantRemoving:Connect(function(p183_)
	...
	while true do
		...
		if v245_.primaryPart then
			...
			while true do
				...
				if v250_ and (v250_ == p240_ and (v250_:GetAttribute("Glue") or v250_:GetAttribute("GluePrimary"))) and not v250_:GetAttribute("IsAnchored") then
					v244_ = true
					break
				end
			end
...
local function v_u_298_()
	...
	elseif v279_ == 1 then
		...
		if v_u_282_ then
			...
			local v297_ = v_u_14_.Heartbeat:Connect(function()
...
controltween1 = v_u_9_:Create(v_u_7_.CurrentCamera, TweenInfo.new(0.3, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, 0, true), {
	["FieldOfView"] = 120
})
controltween2 = v_u_9_:Create(controleffectsatur, TweenInfo.new(0.3, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
	["TintColor"] = Color3.fromRGB(210, 218, 255)
})
controltween3 = v_u_9_:Create(controleffectsatur, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, - 1, true), {
	["Brightness"] = - 0.1
})
controltween4 = v_u_9_:Create(controleffectsatur, TweenInfo.new(0.3, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
...
function controlCreature(p_u_315_)
	...
	if typeof(p_u_315_) == "Instance" and p_u_315_:IsA("Model") then
		...
		local v_u_320_ = (function()
			-- upvalues: (ref) v_u_5_, (ref) p_u_315_
			if not v_u_5_:GetPlayerFromCharacter(p_u_315_) and (p_u_315_.Name == "YouDecoy" or (p_u_315_.Name == "CreatureBlobman" or tostring(p_u_315_.Parent.Name) == "Robloxians")) then
				return true
			end
		end)()
		if v_u_316_ and (v_u_317_ and (v318_ or nil)) then
			...
			v_u_321_[1] = v_u_317_.Died:Connect(function()
				_G.ControllingCreature = nil
			end)
			...
			if v329_ then
				...
				v328_.Parent = v330_
				v_u_321_[2] = v_u_332_.Died:Connect(function()
					_G.ControllingCreature = nil
				end)
				v_u_321_[3] = v_u_10_.JumpRequest:Connect(function()
					-- upvalues: (ref) v_u_317_
					v_u_317_:ChangeState("Jumping")
				end)
				v_u_321_[5] = v_u_332_.Changed:Connect(function(p333_)
					-- upvalues: (ref) v_u_327_, (ref) v_u_332_
					if p333_ == "MoveDirection" then
						v_u_327_.Velocity = v_u_332_.MoveDirection * 20
					end
				end)
				v_u_321_[6] = workspace.CurrentCamera.Changed:Connect(function(p334_)
				...
				local v_u_335_ = nil
				v_u_321_[7] = v_u_319_.Changed:Connect(function(p336_)
...
local function v_u_348_(p345_)
	...
	if type(p345_) == "string" then
		...
		local v347_ = p345_:lower() == "all" and true or (p345_:lower() == v_u_17_.Name:sub(1, p345_:len()):lower() and true or nil)
...
function DevJoinEffect()
	...
	v_u_9_:Create(v358_, TweenInfo.new(5), {
		["Brightness"] = 0
	}):Play()
	...
	while task.wait(1) do
		...
		while true do
			...
			if v_u_379_ ~= v_u_17_ and (v_u_51_(v_u_379_) and not v_u_379_:GetAttribute("Inject")) then
				...
				v_u_379_.Chatted:Connect(function(p380_)
...
function CheckObjectsAroundPlayer()
	...
	if v408_ then
		...
		local function v414_(p411_)
			...
			if not p411_:IsDescendantOf(v_u_7_.Map) and (not p411_:IsDescendantOf(v_u_7_.Plots) and (not p411_:IsDescendantOf(v_u_7_.Waypoints) and (not p411_:IsDescendantOf(v_u_7_.Slots) and p411_.Parent))) and (p411_.Parent:IsA("Model") and (p411_.Parent:FindFirstChildOfClass("BasePart") or (p411_.Parent:FindFirstChildOfClass("Part") or p411_.Parent:FindFirstChildOfClass("MeshPart")))) then
...
local function v_u_434_()
	...
	while true do
		...
		if v429_.Name == "SprayCanWD" and (v429_:FindFirstChild("StickyRemoverPart") and (v429_.PrimaryPart and Getdistancefromcharacter(v429_.PrimaryPart.Position) < 30)) then
	...
	if not v_u_428_ then
		if v423_ then
			local v430_ = {
				"SprayCanWD",
				CFrame.new(v423_.Position.X, v423_.Position.Y, v423_.Position.Z, - 0.133750245, - 0.471861839, 0.871468484, - 3.7252903e-9, 0.879369617, 0.476139903, - 0.991015136, 0.0636838302, - 0.117615893),
	...
	if v_u_428_ and v_u_428_:FindFirstChild("StickyRemoverPart") and (v_u_428_.StickyRemoverPart:FindFirstChildOfClass("TouchTransmitter") and not v_u_428_:GetAttribute("Connected")) then
		local v_u_432_ = v_u_428_.DescendantAdded:Connect(function(p431_)
...
local function v_u_466_()
	...
	if not v_u_454_ then
		...
		if v456_ then
			if v_u_448_(v456_) then
				...
				elseif v457_ and v459_.Attachment1 and (v459_.Attachment1:IsDescendantOf(v_u_17_.Character) and not v458_.EatingSound.IsPlaying) then
				...
				elseif not v457_ and v459_.Attachment1 and v459_.Attachment1:IsDescendantOf(v_u_17_.Character) then
					local v461_ = {
						v456_,
						CFrame.new(v449_.Position.X, v449_.Position.Y, v449_.Position.Z, - 0.133750245, - 0.471861839, 0.871468484, - 3.7252903e-9, 0.879369617, 0.476139903, - 0.991015136, 0.0636838302, - 0.117615893),
						Vector3.new(0, 97.69000244140625, 0)
					}
	...
	if v_u_454_ and v_u_454_:FindFirstChild("HoldPart") and (v_u_454_.HoldPart:FindFirstChild("RigidConstraint") and not v_u_454_:GetAttribute("Connected")) then
		local v_u_464_ = v_u_454_.DescendantAdded:Connect(function(p463_)
...
local function v_u_500_()
	...
	while true do
		...
		if v495_.Name == "Campfire" and (v495_.PrimaryPart and (Getdistancefromcharacter(v495_.PrimaryPart.Position) < 30 and v495_.FirePlayerPart.CanBurn.Value)) then
			v_u_493_ = v495_
		end
	end
	if not v_u_493_ then
		if v488_ then
			local v496_ = {
				"Campfire",
				CFrame.new(v488_.Position.X, v488_.Position.Y, v488_.Position.Z, - 0.133750245, - 0.471861839, 0.871468484, - 3.7252903e-9, 0.879369617, 0.476139903, - 0.991015136, 0.0636838302, - 0.117615893),
				Vector3.new(0, 97.69000244140625, 0)
			}
			SpawnToy(v496_)
		end
	...
	if v_u_493_ and v_u_493_:FindFirstChild("FirePlayerPart") and (v_u_493_.FirePlayerPart:FindFirstChild("CanBurn") and not v_u_493_:GetAttribute("Connected")) then
		local v_u_498_ = v_u_493_.DescendantAdded:Connect(function(p497_)
...
function CheckFakeAim()
	...
	while true do
		...
		if v516_.Name == "DiceSmall" and (v516_:FindFirstChild("Center") and (v516_.PrimaryPart and Getdistancefromcharacter(v516_.PrimaryPart.Position) < 30)) then
			v_u_515_ = v516_
		end
	end
	if not v_u_515_ then
		if v510_ then
			local v517_ = {
				"DiceSmall",
				CFrame.new(v510_.Position.X, v510_.Position.Y, v510_.Position.Z, - 0.133750245, - 0.471861839, 0.871468484, - 3.7252903e-9, 0.879369617, 0.476139903, - 0.991015136, 0.0636838302, - 0.117615893),
				Vector3.new(0, 97.69000244140625, 0)
			}
			SpawnToy(v517_)
		end
	...
	if v_u_515_ and (v_u_515_:FindFirstChild("Center") and not v_u_515_:GetAttribute("Connected")) then
		local v_u_519_ = v_u_515_.DescendantAdded:Connect(function(p518_)
			...
			task.spawn(function()
				...
				while v_u_521_.Parent do
					if v_u_17_.Character and v_u_17_.Character:FindFirstChild("CamPart") then
						v_u_525_ = Ray.new(v_u_17_.Character.CamPart.Position, v_u_17_.Character.CamPart.CFrame.lookVector * 5000)
						local v528_, v529_ = v_u_7_:FindPartOnRayWithIgnoreList(v_u_525_, {
							v_u_17_.Character,
							v_u_19_
						})
						v_u_527_ = v529_
...
local v541_ = v_u_4_
local v542_ = v_u_4_.MakeWindow(v541_, {
	["Name"] = "Blitz Crack by iksuwu - Keyless",
	["HidePremium"] = true,
	["SaveConfig"] = true,
...
local v543_ = v542_:MakeTab({
	["Name"] = "Combat",
	["Icon"] = "rbxassetid://7485051715",
	["PremiumOnly"] = false
})
LongReachGrab_Player = v542_:MakeTab({
	["Name"] = "Blobman Grab",
	["Icon"] = "rbxassetid://7734058599",
	["PremiumOnly"] = false
})
local v544_ = v542_:MakeTab({
	["Name"] = "Invincibility",
	["Icon"] = "rbxassetid://7734056608",
	["PremiumOnly"] = false
})
local v545_ = v542_:MakeTab({
	["Name"] = "Player",
	["Icon"] = "rbxassetid://7743871002",
	["PremiumOnly"] = false
})
Esp_Tab = v542_:MakeTab({
	["Name"] = "ESP",
	["Icon"] = "rbxassetid://7733774602",
	["PremiumOnly"] = false
})
local v546_ = v542_:MakeTab({
	["Name"] = "Explosions",
	["Icon"] = "rbxassetid://17837704089",
	["PremiumOnly"] = false
})
local v547_ = v542_:MakeTab({
	["Name"] = "Teleport",
	["Icon"] = "rbxassetid://7733992829",
	["PremiumOnly"] = false
})
local v548_ = v542_:MakeTab({
	["Name"] = "Custom Line",
	["Icon"] = "rbxassetid://7734022107",
	["PremiumOnly"] = false
})
local v549_ = v542_:MakeTab({
	["Name"] = "Grab Auras",
	["Icon"] = "rbxassetid://7733955740",
	["PremiumOnly"] = false
})
local v550_ = v542_:MakeTab({
	["Name"] = "Keybinds",
	["Icon"] = "rbxassetid://11710306232",
	["PremiumOnly"] = false
})
local v551_ = v542_:MakeTab({
	["Name"] = "Loop Players",
	["Icon"] = "rbxassetid://7733964640",
	["PremiumOnly"] = false
})
local v552_ = v542_:MakeTab({
	["Name"] = "Auto",
	["Icon"] = "rbxassetid://7733916988",
	["PremiumOnly"] = false
})
local v553_ = v542_:MakeTab({
	["Name"] = "Misc",
	["Icon"] = "rbxassetid://7733917120",
	["PremiumOnly"] = false
})
local v_u_554_ = v542_:MakeTab({
	["Name"] = "Discord Server",
	["Icon"] = "rbxassetid://16570630989",
	["PremiumOnly"] = false
})
local v555_ = v542_:MakeTab({
	["Name"] = "Config",
...
task.spawn(function()
	...
	local v558_, v559_ = pcall(function()
	...
	local v560_ = v_u_554_:AddSection({
		["Name"] = "Discord Server"
	})
...
local v561_ = v556_:AddSection({
	["Name"] = "1# Medal credits"
})
local v562_ = v556_:AddSection({
	["Name"] = "2# Medal credits"
})
local v563_ = v556_:AddSection({
...
local v566_, v567_ = ypcall(function()
...
if v566_ then
	v561_:AddParagraph(v572_[1].DisplayName .. " (" .. v572_[1].Username .. ")", "I made the whole GUI (Combat, Player, Auras and more) XD!")
	v561_:AddParagraph(v572_[2].DisplayName .. " (" .. v572_[2].Username .. ")", "Thanks for giving me inspiration to create the blobman functions, Massless Grab and Line color changer script!")
	v561_:AddParagraph(v572_[3].DisplayName .. " (" .. v572_[3].Username .. ") " .. "and " .. v572_[6].DisplayName .. " (" .. v572_[6].Username .. ")", "Thanks for sharing the Attraction Aura, Silent Aim, Further Extend scripts for me!")
	v561_:AddParagraph(v572_[7].DisplayName .. " (" .. v572_[7].Username .. ")", "Thanks for helping me to fix kick stuff and my anti-blobman")
	v561_:AddParagraph(v572_[8].DisplayName .. " (" .. v572_[8].Username .. ")", "Thanks for explosion stuff, fireproximityprompt fix and script updater")
	v561_:AddParagraph(v572_[9].DisplayName .. " (" .. v572_[9].Username .. ")", "Thanks for laggy stuff!")
	v561_:AddParagraph(v572_[10].DisplayName .. " (" .. v572_[10].Username .. ")", "Thanks for Anchor Objects Glue/Compile")
	v562_:AddParagraph(v572_[4].DisplayName .. " (" .. v572_[4].Username .. ")", "Thanks for releasing my script!")
	v563_:AddParagraph(v572_[5].DisplayName .. " (" .. v572_[5].Username .. ")", "Thanks for testing my scripts")
end
...
perspectiveON_effect1 = v_u_9_:Create(ImageLabel, t1p, {
	["ImageTransparency"] = imagestransparencyeffect
})
perspectiveON_effect2 = v_u_9_:Create(PerspectiveSaturation, t1p, {
	["Saturation"] = saturationvalue
})
perspectiveOff_effect1 = v_u_9_:Create(ImageLabel, t2p, {
	["ImageTransparency"] = 1
})
perspectiveOff_effect2 = v_u_9_:Create(PerspectiveSaturation, t2p, {
	["Saturation"] = 0
})
...
if CAG then
	CAG.DescendantAdded:Connect(function(p586_)
...
v_u_7_.ChildAdded:Connect(function(p589_)
		...
		if _G.FutherExtend and v_u_10_.MouseEnabled then
			...
			task.spawn(function()
				...
				while v_u_590_.Parent do
					v_u_593_.Position = v_u_7_.Camera.CFrame.Position + v_u_7_.Camera.CFrame.LookVector * pcDistance
					task.wait()
				end
				pcDistance = 0
				v_u_593_:Destroy()
...
workspace.ChildRemoved:Connect(function(p594_)
...
imageButton.InputBegan:Connect(function(p599_, p600_)
...
imageButtonDe.InputEnded:Connect(function(p604_)
	-- upvalues: (ref) v_u_598_, (ref) v_u_595_
	if v_u_598_.TouchEnabled and p604_.UserInputType == Enum.UserInputType.Touch then
		v_u_595_ = false
	end
end)
v_u_10_.InputChanged:Connect(function(p605_)
...
local function v_u_622_(_)
	...
	while true do
		...
		if v617_.Name ~= v_u_607_.Name and (v617_.Character and (v_u_607_ and v_u_607_.Character)) and v_u_607_.Character:FindFirstChild("HumanoidRootPart") then
...
v_u_14_.RenderStepped:Connect(function()
...
local v_u_633_ = nil
v_u_633_ = hookmetamethod(game, "__namecall", function(...)
    local v634_ = {...}  -- 元の引数
    local v635_ = v634_[1]
    local v636_ = getnamecallmethod()

    if v635_ == workspace and not checkcaller() and v636_ == "Raycast" 
       and v_u_623_ and v_u_623_.Character and v_u_623_.Character:FindFirstChild("HumanoidRootPart")
       and v_u_607_ and v_u_607_.Character and v_u_607_.Character:FindFirstChild("HumanoidRootPart")
       and v_u_623_.Character:FindFirstChild("Humanoid") and v_u_623_.Character.Humanoid.Health > 0
       and not v_u_623_:FindFirstChild("InPlot") and _G.SilentAim then

        local v637_ = (v_u_607_.Character.HumanoidRootPart.Position - v_u_623_.Character.HumanoidRootPart.Position).magnitude
...
local v650_ = v552_:AddSection({
	["Name"] = "Auto Get Coins"
})
local v651_ = v552_:AddSection({
	["Name"] = "Auto Time-Reset"
})
local v652_ = v552_:AddSection({
		...
		if p653_ then
			while _G.AutoFarmCoins do
				if v_u_643_() then
					v_u_646_("Spin")
					local v_u_654_ = nil
					local v655_ = task.spawn(function()
...
timelefttextlabelingame.Changed:Connect(function(p661_)
	if p661_ == "Text" then
...
task.spawn(function()
	...
	while true do
		...
		if v_u_665_.Name == "CoinAmount" and tostring(v_u_665_.Parent) == "CoinsFrame" then
			v_u_665_.Changed:Connect(function(p666_)
	...
	v_u_7_.Plots.DescendantAdded:Connect(function(p668_)
		-- upvalues: (ref) v_u_17_
		if p668_.Name == "Value" and (tostring(p668_.Parent) == "ThisPlotsOwners" and p668_.Value == v_u_17_.Name) then
			RTime = p668_:WaitForChild("TimeRemainingNum", 1)
			if RTime then
				RTime.Changed:Connect(function(p669_)
...
task.spawn(function()
	...
	while true do
		...
		if v673_.Name == "TimeRemainingNum" and v673_.Parent.Value == v_u_17_.Name then
			...
			v673_.Changed:Connect(function(p674_)
...
function UpdatePlotOwner()
	...
	while true do
		...
		if v700_.Name == "PlayerRole" then
			...
			v_u_702_.Changed:Connect(function(p712_)
				-- upvalues: (ref) v_u_711_
				if p712_ == "Text" then
					v_u_711_()
				end
			end)
			v_u_679_.Changed:Connect(function(_)
				-- upvalues: (ref) v_u_711_
				v_u_711_()
			end)
			v_u_711_()
...
function modify(p748_)
	...
	local v749_ = CFrame.new(- 410, 228.394, 510, - 0.246182978, 3.22764193e-9, - 0.96922338, 1.2914926e-8, 1, 4.97377278e-11, 0.96922338, - 1.2505204e-8, - 0.246182978)
			...
			if CheckNetworkOwnerShipOnPart(v750_) then
				if v751_ then
					if v_u_727_[v750_] then
						...
						v751_.Position = v749_.Position + Vector3.new(25, 0, 0) + Vector3.new(0, v750_.Size.X / 2 - 0.65, 0)
						wait(0.5)
						v751_.Position = v749_.Position + Vector3.new(- 25, 0, 0) + Vector3.new(0, v750_.Size.X / 2 - 0.65, 0)
						wait(0.5)
...
automakesnowballtoggle = v754_:AddToggle({
		...
		if v770_.Name == spamexplosiontype then
			...
			if spamexplosiontarget ~= 0 then
				if spamexplosiontarget ~= 1 then
					...
					if v773_ and (not IsPlayerInsideSafeZone(v773_) and v773_.Character) and v773_.Character:FindFirstChild("HumanoidRootPart") then
...
firework_section = v546_:AddSection({
	["Name"] = "Explosions Spam"
})
explosionexplanation = v546_:AddSection({
		...
		if p775_ then
			task.spawn(function()
				while _G.FireworkEffectSpam do
					...
					if countToys(spamexplosiontype) < bombsammountoexplode and (not reachedrightammount and (spamexplosiontarget ~= 2 or GetFakeAim())) and v776_ then
						SpawnToy({
							spamexplosiontype,
							CFrame.new(v776_.Position.X, v776_.Position.Y, v776_.Position.Z, - 0.3092496991157532, 0.2610282301902771, - 0.9144555330276489, 0, 0.9615919589996338, 0.2744831442832947, 0.9509809017181396, 0.08488383144140244, - 0.2973720133304596),
							Vector3.new(0, 97.69000244140625, 0)
						})
					end
					task.wait()
				...
				while _G.FireworkEffectSpam do
					...
					while true do
						...
						if v781_.Name == spamexplosiontype then
							...
							if v782_ and not SNOWshipOnce(v782_) and v_u_17_:DistanceFromCharacter(v782_.Position) > 30 then
								DeleteToyRE:FireServer(v781_)
								print("Deletado!")
							elseif v782_ and (CheckNetworkOwnerShipOnPart(v782_) and not v781_:GetAttribute("MissileTeleported")) then
								wait()
								if v781_.PrimaryPart then
									Instance.new("BodyVelocity", v781_.PrimaryPart).Velocity = Vector3.new(10000, 10000, 10000)
									v781_:SetPrimaryPartCFrame(CFrame.new(math.random(- 1000, 1000), 10000, math.random(- 1000, 1000)))
...
v_u_17_.Idled:connect(function()
...
local v795_ = v549_:AddSection({
	["Name"] = "Normal Auras"
})
local v796_ = v549_:AddSection({
	["Name"] = "Fling Aura"
})
local v797_ = v549_:AddSection({
	["Name"] = "Kick Aura"
})
local v798_ = v549_:AddSection({
...
local function v_u_801_()
	...
	if not v799_ or (not v800_ or (not v800_.Sit or (v800_.SeatPart == nil or tostring(v800_.SeatPart.Parent) ~= "CreatureBlobman"))) then
		return false
	end
...
local function v_u_810_(p809_)
	...
	if typeof(p809_) == "Instance" and (p809_ ~= v_u_17_ and (not v_u_51_(p809_) and p809_.Character)) and (p809_.Character:IsDescendantOf(v_u_7_) and (p809_.Character:FindFirstChild("HumanoidRootPart") and (p809_.Character:FindFirstChildOfClass("Humanoid") and p809_.Character.Humanoid.Health > 0))) then
		return true
	end
end
...
local function v_u_814_(p813_)
	...
	if v_u_810_(p813_) and not (v_u_97_(p813_.Name) and _G.WhitelistFriends) and not v_u_808_(p813_.Name) and not (p813_.Character:GetAttribute("Kicking") or _G.KickAura) then
		return true
	end
end
local function v_u_816_(p815_)
	-- upvalues: (ref) v_u_810_, (ref) v_u_97_, (ref) v_u_808_
	if v_u_810_(p815_) and not (v_u_97_(p815_.Name) and _G.WhitelistFriends) and not v_u_808_(p815_.Name) and not p815_.Character:GetAttribute("Kicking") then
		return true
	end
end
local function v_u_818_(p817_)
	-- upvalues: (ref) v_u_810_, (ref) v_u_97_, (ref) v_u_808_
	if v_u_810_(p817_) and not (v_u_97_(p817_.Name) and _G.WhitelistFriends3) and not v_u_808_(p817_.Name) and not p817_.Character:GetAttribute("Kicking") then
		return true
	end
end
...
local function v_u_822_(p821_)
	-- upvalues: (ref) v_u_810_, (ref) v_u_97_
	if v_u_810_(p821_) and not (v_u_97_(p821_.Name) and _G.WhitelistFriends3) and not (IsPlayerInsideSafeZone(p821_) or IsPlayerFloating(p821_)) then
		return true
	end
end
									...
									if v867_:IsA("BasePart") and v867_.CanQuery then
										...
										if v868_ and v869_ then
											...
											elseif not v867_:FindFirstChild("FlingAuraVelocity") then
												...
												v872_.Velocity = Vector3.new(v871_.lookVector.X, 0.5, v871_.lookVector.Z) * math.clamp(_G.FlingStrength, 400, 600)
					...
					while true do
						...
						if v_u_814_(v877_) then
							...
							if v878_ and (v879_ and (v880_ and not v878_:FindFirstChild("FlingAuraVelocity"))) then
								...
								v882_.Velocity = Vector3.new(v881_.lookVector.X, 0.5, v881_.lookVector.Z) * _G.FlingStrength
...
kickauratoggle = v797_:AddToggle({
	["Name"] = "Kick Aura",
	["Default"] = false,
			...
			while _G.KickAura do
				...
				while true do
					...
					if v_u_816_(v916_) then
						...
						if v918_ and (v917_:FindFirstChildOfClass("Humanoid") and (v918_:FindFirstChild("FirePlayerPart") and SNOWshipPlayer(v916_))) then
...
local v921_ = v543_:AddSection({
	["Name"] = "Strength"
})
local v922_ = v543_:AddSection({
	["Name"] = "Others"
})
local v923_ = v543_:AddSection({
	["Name"] = "Perspective"
})
v921_:AddToggle({
	["Name"] = "Super Strength",
...
local v936_ = v553_:AddSection({
	["Name"] = "Annoy Players"
})
local v937_ = v553_:AddSection({
	["Name"] = "Kick All"
})
local v938_ = v553_:AddSection({
	["Name"] = "Whitelist"
})
local v_u_939_ = nil
v_u_939_ = v936_:AddToggle({
	["Name"] = "Fire All",
	["Default"] = false,
...
annoyalltoggle = v936_:AddToggle({
	["Name"] = "Ragdoll All",
	["Default"] = false,
					...
					if v_u_820_(v962_) then
						...
						if v962_ and (v963_ and v964_) then
							for _ = 0, 50 do
								v_u_349_()
								SNOWship(v963_)
								if not v_u_820_(v962_) or (not _G.KillAll or (CheckNetworkOwnerShipOnPlayer(v962_) or v963_.AssemblyLinearVelocity.Magnitude > 500)) then
					...
					if v_u_822_(v970_) then
						...
						if v970_ and v971_ then
							for _ = 0, 50 do
								v_u_349_()
								SNOWship(v971_)
								if not v_u_822_(v970_) or (not _G.KickAll or (CheckNetworkOwnerShipOnPlayer(v970_) or v971_.AssemblyLinearVelocity.Magnitude > 500)) then
...
local v974_ = v544_:AddSection({
	["Name"] = "Invulnerability"
})
local v975_ = v544_:AddSection({
	["Name"] = "Counter-Attack"
})
v974_:AddToggle({
	["Name"] = "Anti-Grab",
...
counterdropdownselection = v975_:AddDropdown({
	["Name"] = "Counter Mode",
	["Default"] = "Repulsion",
	["Options"] = {
		"Repulsion",
...
floppatween = v_u_9_:Create(Floppa, floppatweeninfo1, {
...
function antivoidmesssage()
	if not floppamessageoncooldown then
		...
		floppatween:Play()
		floppatween.Completed:Connect(function(p981_)
...
antikicktoggle = v974_:AddToggle({
	["Name"] = "Anti-Kick",
	["Default"] = false,
...
function CreateIconOnPlayer(p1009_)
	if p1009_.Character then
		...
		if not v_u_1010_:FindFirstChild("ESP") and v1011_ then
			...
			v_u_1012_.UserImage.Image = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. p1009_.UserId .. "&width=420&height=420&format=png"
			task.spawn(function()
		...
		if p1013_ then
			...
			local function v_u_1021_(p_u_1020_)
				...
				if p_u_1020_ ~= v_u_17_ and (p_u_1020_.Character or p_u_1020_.CharacterAdded:Wait()) then
					...
					v_u_1014_[# v_u_1014_ + 1] = p_u_1020_.CharacterAdded:Connect(function(_)
			...
			local v1029_ = v_u_5_.PlayerAdded:Connect(function(p1028_)
...
MapTeleport_Section = v547_:AddSection({
	["Name"] = "Place TP"
})
PlayerTeleport_Section = v547_:AddSection({
	["Name"] = "Player TP"
})
placeLocations = {
			...
			if _G.PlayerToTeleportDirection ~= "Right" then
				if _G.PlayerToTeleportDirection ~= "Left" then
					if _G.PlayerToTeleportDirection == "Rotate" and (p1034_ and p1035_) then
						local v1038_ = 0
						while _G.PlayerToTeleportDirection == "Rotate" and (_G.LoopPlayerTP and (p1035_:IsDescendantOf(v_u_7_) and p1036_ == _G.PlayerToTeleport)) do
							v1038_ = v1038_ + 0.1
							v1037_ = CFrame.new(p1034_.Position + Vector3.new(math.clamp(math.cos(v1038_), - 1, 1), 0, math.clamp(math.sin(v1038_), - 1, 1)) * (TeleportPlayerOffset + 1), p1034_.Position)
...
PlayerTeleport_Section:AddButton({
	...
	["Callback"] = function()
		...
		local v1041_ = v1039_ and (v1039_.Character and v1040_) and v1039_.Character:FindFirstChild("HumanoidRootPart")
		if v1041_ then
...
PlayerLockCamera = PlayerTeleport_Section:AddToggle({
	...
	["Callback"] = function(p1046_)
		...
		if p1046_ then
			...
			local v_u_1050_ = nil
			local v_u_1051_ = nil
			v_u_1051_ = v_u_14_.RenderStepped:Connect(function()
				...
				if v_u_1047_ and (v_u_1047_.Character and v_u_1050_) then
					...
					if v_u_1048_ then
						v_u_1050_.CFrame = CFrame.lookAt(v_u_1050_.CFrame.Position, v_u_1048_.CFrame.Position + Vector3.new(0, 1, 0))
					end
...
WS_Section = v545_:AddSection({
	["Name"] = "Walkspeed"
})
JP_Section = v545_:AddSection({
	["Name"] = "Infinite Power Jump"
})
NC_Section = v545_:AddSection({
	["Name"] = "Noclip"
})
...
local v1065_ = v548_:AddSection({
	["Name"] = "Change your entire line color"
})
local v1066_ = v548_:AddSection({
	["Name"] = "Line Effects"
})
local v1067_ = v548_:AddSection({
	["Name"] = "Stress Server"
})
LagServerToggle = nil
LagServerToggle = v1067_:AddToggle({
	["Name"] = "Lag Server",
	["Default"] = false,
	...
	["Callback"] = function()
		...
		while true do
			...
			if v1077_ == 1 then
				...
				v_u_1064_[v1077_] = Color3.new(_G.LineColorChangeValue.R / 255, _G.LineColorChangeValue.G / 255, _G.LineColorChangeValue.B / 255)
			end
		end
		...
		if p1079_ then
			...
			while _G.CrazyLine do
				...
				while true do
					...
					if v1084_ and (v1084_ ~= v_u_17_ and v1084_.Character) and v1084_.Character:FindFirstChild("Torso") then
						v_u_22_:FireServer(v1084_.Character:FindFirstChild("Torso"), CFrame.new(0.12640380859375, 0.9606337547302246, - 0.5000009536743164, 0.9985212683677673, 0, - 0.05436277016997337, - 6.4805472099749295e-9, 1, - 1.1903301100346653e-7, 0.05436277016997337, 5.960464477539063e-8, 0.9985212683677673))
					end
					task.wait()
				end
			end
...
v1066_:AddParagraph("Note!", "You can\'t see the effects line, but others player can see it. And Invisible Line won\'t work if Crazy Line is Enabled")
...
local v1092_ = v550_:AddSection({
	["Name"] = "Teleport"
})
local v1093_ = v550_:AddSection({
	["Name"] = "Spawn Toy"
})
local v1094_ = v550_:AddSection({
	["Name"] = "Anchor"
})
local v1095_ = v550_:AddSection({
...
local v1102_ = v555_:AddSection({
	["Name"] = "Whitelist"
})
local v_u_1104_ = v1102_:AddDropdown({
	["Name"] = "Select Player",
	["Default"] = "",
	["Options"] = {
		""
...
local v1111_ = v555_:AddSection({
	["Name"] = "Blobman Loopkick"
})
local v1112_ = v555_:AddSection({
	["Name"] = "Perspective"
})
v555_:AddSection({
	["Name"] = "Anchor Objects"
...
local v1117_ = v551_:AddSection({
	["Name"] = "Loop Players"
})
local v1118_ = v551_:AddSection({
	["Name"] = "Players in Loop"
})
local v1119_ = v551_:AddSection({
	["Name"] = "Loop Kill Functions"
})
local v1120_ = v551_:AddSection({
	["Name"] = "Loop Kick (Blobman)"
})
local v_u_1122_ = v1117_:AddDropdown({
	["Name"] = "Select Player",
	["Default"] = "",
	["Options"] = {
		""
...
local v_u_1126_ = v1118_:AddDropdown({
	["Name"] = "Players in Loop",
	["Default"] = "",
	["Options"] = {
		""
					...
					if v_u_812_(v1163_) then
						...
						if v1163_ and (v1164_ and v1165_) then
							for _ = 0, 50 do
								v_u_349_()
								SNOWship(v1164_)
								if not v_u_812_(v1163_) or (not _G.LoopKill or (CheckNetworkOwnerShipOnPlayer(v1163_) or v1164_.AssemblyLinearVelocity.Magnitude > 500)) then
...
local v1167_ = v551_:AddSection({
	["Name"] = "Loop Kick (Ownership)"
})
loopkickownertoggle = v1167_:AddToggle({
	["Name"] = "Loop Kick",
	["Default"] = false,
					...
					if v_u_812_(v1173_) then
						...
						if v1173_ and (v1174_ and v1175_) then
							for _ = 0, 50 do
								v_u_349_()
								SNOWship(v1174_)
								if not v_u_812_(v1173_) or (not _G.LoopKickOwnership or (CheckNetworkOwnerShipOnPlayer(v1173_) or v1174_.AssemblyLinearVelocity.Magnitude > 500)) then
			...
			while _G.LoopFire do
				...
				while true do
					...
					if v_u_818_(v1191_) then
						...
						local v1193_
						if v1192_:FindFirstChild("FirePlayerPart") and v1192_.FirePlayerPart:FindFirstChild("CanBurn") then
...
local function v_u_1208_(p1194_, p1195_)
	...
	if v_u_801_() then
		...
		if v1198_ and v1198_.Character and (v1198_.Character:FindFirstChild("HumanoidRootPart") and (v1197_ and not v_u_51_(v1198_))) then
			local v1199_ = {
				v1197_.LeftDetector,
			...
			if v1197_ then
				...
				elseif p1195_ == 2 then
					...
					task.wait(0.155)
					v1196_.Sit = false
				elseif p1195_ == 3 and not (v1198_.Character:GetAttribute("Kicking") or v1198_.Character:GetAttribute("Kicking2")) then
					...
					for _ = 0, 25 do
						if SNOWshipPlayer(v1202_) then
							...
							while v_u_801_() and v1207_ < 100 do
								if v1205_.FloorMaterial == Enum.Material.Air and v_u_17_:DistanceFromCharacter(v1204_.Position) > 100 then
...
function blobmangraball()
	...
	while true do
		...
		if not v_u_51_(v1218_) and (v1218_ ~= v_u_17_ and v1218_.Character) and (v1218_.Character:FindFirstChild("HumanoidRootPart") and not (v_u_97_(v1218_.Name) and _G.WhitelistFriends2) and v_u_17_.Character and v_u_17_.Character:FindFirstChildOfClass("Humanoid")) then
...
local v1223_ = LongReachGrab_Player:AddSection({
	["Name"] = "Destroy Everything"
})
local v_u_1224_ = nil
v_u_1224_ = v1223_:AddToggle({
	["Name"] = "Destroy Server",
	["Default"] = false,
...
v_u_7_.ChildAdded:Connect(function(p_u_1227_)
	...
	if p_u_1227_.Name == "GrabParts" then
		...
		if v_u_1228_ then
			...
			if _G.PerspectiveGrab and not v_u_1228_.Anchored then
				task.spawn(function()
					...
					if v_u_1248_ and v_u_1249_ then
						...
						local v_u_1257_ = nil
						local v_u_1258_ = nil
						v_u_932_ = v_u_14_.Heartbeat:Connect(function(p1259_)
							...
							v_u_1258_ = CFrame.new(v_u_1256_, Vector3.new(v_u_1257_.X, v_u_1256_.Y, v_u_1257_.Z)):VectorToObjectSpace(v_u_1252_)
							v_u_1250_.CFrame = CFrame.new(v_u_1257_) * (v_u_1254_ - v_u_1256_) * CFrame.new(v_u_1258_)
						...
						v_u_585_(false)
						workspace.CurrentCamera.CameraSubject = v_u_17_.Character:FindFirstChildOfClass("Humanoid")
			...
			task.spawn(function()
				...
				if v_u_1229_ then
					...
					while v1261_ == nil and p_u_1227_.Parent do
						local v1264_, v1265_, v1266_ = pairs(game.Players.LocalPlayer.PlayerGui.ContextActionGui:GetDescendants())
						while true do
							local v1267_
							...
							if v1267_:IsA("ImageLabel") and v1267_.Image == "http://www.roblox.com/asset/?id=9603678090" then
					...
					v1261_.Active = true
					if v1261_ then
						v_u_1262_ = v1261_.MouseButton1Down:Connect(function()
					...
					local _ = p_u_1227_:GetPropertyChangedSignal("Parent"):Connect(function()
			...
			task.spawn(function()
				...
				if v_u_1229_ then
					local v_u_1268_ = nil
					v_u_1268_ = p_u_1227_:GetPropertyChangedSignal("Parent"):Connect(function()
						-- upvalues: (ref) p_u_1227_, (ref) v_u_10_, (ref) v_u_1229_, (ref) v_u_6_, (ref) v_u_1268_
						if not p_u_1227_.Parent then
							if v_u_10_:GetLastInputType() ~= Enum.UserInputType.MouseButton2 or not _G.SuperStrength then
...
workspace.DescendantAdded:Connect(function(p1272_)
	-- upvalues: (ref) v_u_17_
...
v_u_27_.Changed:Connect(function(p1274_)
	...
	if p1274_ == true and (not v_u_51_(v_u_5_:FindFirstChild(v_u_29_)) and _G.AntiGrab) then
		...
		if v_u_27_.Value then
			local v_u_1276_ = nil
			v_u_1276_ = v_u_14_.Heartbeat:Connect(function()
...
function enforceMasslessFalse(p1282_)
	p1282_.DescendantAdded:Connect(function(p_u_1283_)
		if p_u_1283_:IsA("BasePart") then
			p_u_1283_:GetPropertyChangedSignal("Massless"):Connect(function()
	...
	while true do
		...
		if v_u_1287_:IsA("BasePart") then
			v_u_1287_:GetPropertyChangedSignal("Massless"):Connect(function()
...
function reconnect()
	...
	if getgenv().key == "Xana" then
		...
		v1288_.DescendantAdded:Connect(function(p1294_)
	...
	v1288_.DescendantAdded:Connect(function(p1296_)
	...
	v_u_1291_.Changed:Connect(function(p1308_)
		...
		if p1308_ and _G.AntiBurn then
			while v_u_1291_.Value do
				if firetouchinterest then
					...
					apagarfogo.CFrame = v_u_1290_.FirePlayerPart.CFrame * CFrame.new(math.random(- 1, 1), math.random(- 1, 1), math.random(- 1, 1))
					task.wait()
	...
	v_u_1292_.Changed:Connect(function(p1309_)
	...
	v_u_1289_.Changed:Connect(function(p1310_)
...
v_u_10_.JumpRequest:Connect(function()
	-- upvalues: (ref) v_u_17_
	if _G.InfiniteJump then
		v_u_17_.Character:FindFirstChildOfClass("Humanoid"):ChangeState("Jumping")
	end
end)
v_u_14_.Heartbeat:Connect(function()
	-- upvalues: (ref) v_u_17_
	if _G.SuperSpeed then
		v_u_17_.Character.HumanoidRootPart.CFrame = v_u_17_.Character.HumanoidRootPart.CFrame + v_u_17_.Character:FindFirstChildOfClass("Humanoid").MoveDirection * Multiplier
	end
end)
...
v_u_5_.PlayerAdded:Connect(function(p1320_)
